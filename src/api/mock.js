...
//模拟请求就是拦截下来后加载数据
Mock.mock("http://210.29.124.167:8008/api/index/banner",{code:'200',msg:'success'})
...
Mock.mock("http://210.29.124.167:8008/api/category/index",{code:'200',data:{categoryList,currentCategory,currentSubCategory}})